package starling.utils
{
   ...
   public class Color
   {
      ...
      public static function multiply(param1:uint, param2:Number) : uint
      {
         ...
         var _loc3_:uint = (param1 >> 24 & 0xFF) * param2;
         var _loc4_:uint = (param1 >> 16 & 0xFF) * param2;
         var _loc5_:uint = (param1 >> 8 & 0xFF) * param2;
         var _loc6_:uint = (param1 & 0xFF) * param2;
         if(_loc3_ > 255)
         {
            _loc3_ = 255;
         }
      ...
      {
         var _loc4_:uint = uint(param1 >> 24 & 0xFF);
         var _loc5_:uint = uint(param1 >> 16 & 0xFF);
         var _loc6_:uint = uint(param1 >> 8 & 0xFF);
         var _loc7_:uint = uint(param1 & 0xFF);
         var _loc8_:uint = uint(param2 >> 24 & 0xFF);
         var _loc9_:uint = uint(param2 >> 16 & 0xFF);
         var _loc10_:uint = uint(param2 >> 8 & 0xFF);
         var _loc11_:uint = uint(param2 & 0xFF);
