package starling.rendering
{
   ...
   public class BatchToken
   {
      ...
      {
         super();
         this.setTo(param1,param2,param3);
      }
      
      public function copyFrom(param1:BatchToken) : void
      {
         this.batchID = param1.batchID;
         this.vertexID = param1.vertexID;
         this.indexID = param1.indexID;
      }
      ...
      {
         return this.batchID == param1.batchID && this.vertexID == param1.vertexID && this.indexID == param1.indexID;
      }
