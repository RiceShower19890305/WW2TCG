package starling.utils
{
   ...
   public class Pool
   {
      ...
      private static var sRectangles:Vector.<flash.geom.Rectangle> = new Vector.<flash.geom.Rectangle>(0);
      ...
      public static function getRectangle(param1:Number = 0, param2:Number = 0, param3:Number = 0, param4:Number = 0) : flash.geom.Rectangle
      {
         var _loc5_:flash.geom.Rectangle = null;
         if(sRectangles.length == 0)
         {
            return new flash.geom.Rectangle(param1,param2,param3,param4);
         }
      ...
      public static function putRectangle(param1:flash.geom.Rectangle) : void
      {
         if(param1)
         {
