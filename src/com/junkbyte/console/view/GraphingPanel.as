package com.junkbyte.console.view
{
   ...
   public class GraphingPanel extends ConsolePanel
   {
      ...
      public function GraphingPanel(param1:Console, param2:GraphGroup)
      {
         ...
         var _loc5_:flash.geom.Rectangle = param2.rect;
         var _loc6_:Number = Math.max(minWidth,_loc5_.width);
         var _loc7_:Number = Math.max(minHeight,_loc5_.height);
         var _loc8_:MainPanel = console.panels.mainPanel;
         x = _loc8_.x + _loc5_.x;
         y = _loc8_.y + _loc5_.y;
      ...
      protected function pushBMD(param1:Array) : void
      {
         ...
         this._bmd.fillRect(new flash.geom.Rectangle(_loc3_,0,1,this._bmd.height),0);
