package feathers.media
{
   ...
   public class MuteToggleButton extends ToggleButton implements IMediaPlayerControl
   {
      ...
      {
         super();
         this.addEventListener(Event.CHANGE,this.muteToggleButton_changeHandler);
         this.addEventListener(TouchEvent.TOUCH,this.muteToggleButton_touchHandler);
      }
      
      protected static function defaultVolumeSliderFactory() : VolumeSlider
      {
         var _loc1_:VolumeSlider = new VolumeSlider();
         _loc1_.direction = Direction.VERTICAL;
         return _loc1_;
      }
      ...
      public function openPopUp() : void
      {
         ...
         this.slider.addEventListener(TouchEvent.TOUCH,this.volumeSlider_touchHandler);
      }
      ...
      override protected function initialize() : void
      {
         ...
         if(this._popUpContentManager === null)
         {
            ...
            _loc1_.primaryDirection = RelativePosition.TOP;
      ...
      override protected function draw() : void
      {
         ...
         var _loc2_:Boolean = this.isInvalid(INVALIDATION_FLAG_VOLUME_SLIDER_FACTORY);
         if(_loc2_)
         {
            this.createVolumeSlider();
         }
         if(Boolean(this.slider) && (_loc2_ || _loc1_))
         {
      ...
      protected function refreshVolumeSliderProperties() : void
      {
         ...
         for(_loc1_ in this._volumeSliderProperties)
         {
      ...
      protected function muteToggleButton_changeHandler(param1:Event) : void
      {
         ...
         {
            _loc3_ = this._oldVolume;
            if(_loc3_ !== _loc3_)
            {
               _loc3_ = 1;
            }
            _loc2_.volume = _loc3_;
            this._mediaPlayer.soundTransform = _loc2_;
         }
      }
      ...
      protected function volumeSlider_touchHandler(param1:TouchEvent) : void
      {
         ...
         {
            _loc2_ = param1.getTouch(this.slider,TouchPhase.HOVER);
            if(!_loc2_)
            {
               return;
            }
      ...
      {
         this.slider.removeEventListener(TouchEvent.TOUCH,this.volumeSlider_touchHandler);
