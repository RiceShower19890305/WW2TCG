package starling.utils
{
   ...
   public class MatrixUtil
   {
      ...
      private static function formatRawData(param1:Vector.<Number>, param2:int, param3:int, param4:int, param5:String = "  ") : String
      {
         ...
         {
            _loc10_ = Math.abs(param1[_loc11_]);
            if(_loc10_ > _loc8_)
            {
               _loc8_ = _loc10_;
            }
         ...
         var _loc12_:int = _loc8_.toFixed(param4).length + 1;
         var _loc13_:int = 0;
         while(_loc13_ < param3)
         {
            ...
            {
               _loc10_ = param1[param2 * _loc13_ + _loc14_];
               _loc9_ = _loc10_.toFixed(param4);
               while(_loc9_.length < _loc12_)
               {
                  _loc9_ = " " + _loc9_;
               }
               _loc6_ += _loc9_;
      ...
      public static function snapToPixels(param1:Matrix, param2:Number) : void
      {
         ...
         var _loc3_:Number = 0.0001;
         var _loc4_:Boolean = false;
         if(param1.b + _loc3_ > 0 && param1.b - _loc3_ < 0 && param1.c + _loc3_ > 0 && param1.c - _loc3_ < 0)
         {
            _loc5_ = param1.a * param1.a;
            _loc8_ = param1.d * param1.d;
            _loc4_ = _loc5_ + _loc3_ > 1 && _loc5_ - _loc3_ < 1 && _loc8_ + _loc3_ > 1 && _loc8_ - _loc3_ < 1;
         }
         else if(param1.a + _loc3_ > 0 && param1.a - _loc3_ < 0 && param1.d + _loc3_ > 0 && param1.d - _loc3_ < 0)
         {
            _loc6_ = param1.b * param1.b;
            _loc7_ = param1.c * param1.c;
            _loc4_ = _loc6_ + _loc3_ > 1 && _loc6_ - _loc3_ < 1 && _loc7_ + _loc3_ > 1 && _loc7_ - _loc3_ < 1;
         }
         if(_loc4_)
         {
      ...
      public static function createPerspectiveProjectionMatrix(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number = 0, param6:Number = 0, param7:Vector3D = null, param8:Matrix3D = null) : Matrix3D
      {
         ...
         _loc9_ = Math.abs(param7.z);
         var _loc10_:Number = param7.x - param5 / 2;
         var _loc11_:Number = param7.y - param6 / 2;
         var _loc12_:Number = _loc9_ * 20;
         var _loc13_:Number = 1;
         var _loc14_:Number = param5 / param3;
         var _loc15_:Number = param6 / param4;
         sMatrixData[0] = 2 * _loc9_ / param5;
         sMatrixData[5] = -2 * _loc9_ / param6;
         sMatrixData[10] = _loc12_ / (_loc12_ - _loc13_);
         sMatrixData[14] = -_loc12_ * _loc13_ / (_loc12_ - _loc13_);
         sMatrixData[11] = 1;
         sMatrixData[0] *= _loc14_;
         sMatrixData[5] *= _loc15_;
         sMatrixData[8] = _loc14_ - 1 - 2 * _loc14_ * (param1 - _loc10_) / param5;
         sMatrixData[9] = -_loc15_ + 1 + 2 * _loc15_ * (param2 - _loc11_) / param6;
         param8.copyRawDataFrom(sMatrixData);
         param8.prependTranslation(-param5 / 2 - _loc10_,-param6 / 2 - _loc11_,_loc9_);
         return param8;
      }
