   ...
   public class VertexData
   {
      ...
      public function VertexData(param1:* = null, param2:int = 32)
      {
         ...
         else
         {
            ...
            this._format = VertexDataFormat.fromString(param1 as String);
         }
      ...
      {
         return (param1 & 0xFF) << 24 | (param1 >> 8 & 0xFF) << 16 | (param1 >> 16 & 0xFF) << 8 | param1 >> 24 & 0xFF;
      }
      ...
      private static function premultiplyAlpha(param1:uint) : uint
      {
         ...
         var _loc5_:uint = 0;
         var _loc6_:uint = 0;
         var _loc2_:uint = uint(param1 & 0xFF);
         if(_loc2_ == 255)
         {
            return param1;
         }
         _loc3_ = _loc2_ / 255;
         _loc4_ = (param1 >> 24 & 0xFF) * _loc3_;
         _loc5_ = (param1 >> 16 & 0xFF) * _loc3_;
         _loc6_ = (param1 >> 8 & 0xFF) * _loc3_;
         return (_loc4_ & 0xFF) << 24 | (_loc5_ & 0xFF) << 16 | (_loc6_ & 0xFF) << 8 | _loc2_;
      }
      ...
      {
         var _loc1_:VertexData = new VertexData(this._format,this._numVertices);
      ...
      public function copyTo(param1:VertexData, param2:int = 0, param3:Matrix = null, param4:int = 0, param5:int = -1) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         var _loc12_:VertexDataAttribute = null;
         var _loc13_:VertexDataAttribute = null;
         ...
         if(this._format === param1._format)
         {
            ...
            _loc6_.position = param2 * this._vertexSize;
            _loc6_.writeBytes(this._rawData,param4 * this._vertexSize,param5 * this._vertexSize);
            if(param3)
            {
               _loc9_ = param2 * this._vertexSize + this._posOffset;
               _loc10_ = _loc9_ + param5 * this._vertexSize;
         ...
         else
         {
            ...
            while(_loc11_ < this._numAttributes)
            {
               ...
               _loc13_ = param1.getAttribute(_loc12_.name);
               if(_loc13_)
               {
      ...
      {
         var _loc7_:VertexDataAttribute = this.getAttribute(param3);
         var _loc8_:VertexDataAttribute = param1.getAttribute(param3);
         if(_loc7_ == null)
         {
      ...
      public function setPremultipliedAlpha(param1:Boolean, param2:Boolean) : void
      {
         ...
         if(param2 && param1 != this._premultipliedAlpha)
         {
            ...
            {
               _loc4_ = this._attributes[_loc3_];
               if(_loc4_.isColor)
               {
      ...
      public function transformPoints(param1:String, param2:Matrix, param3:int = 0, param4:int = -1) : void
      {
         ...
         var _loc8_:int = param3 * this._vertexSize + _loc7_;
         var _loc9_:int = _loc8_ + param4 * this._vertexSize;
         while(_loc8_ < _loc9_)
         {
      ...
      public function translatePoints(param1:String, param2:Number, param3:Number, param4:int = 0, param5:int = -1) : void
      {
         ...
         var _loc9_:int = param4 * this._vertexSize + _loc8_;
         var _loc10_:int = _loc9_ + param5 * this._vertexSize;
         while(_loc9_ < _loc10_)
         {
      ...
      public function scaleAlphas(param1:String, param2:Number, param3:int = 0, param4:int = -1) : void
      {
         ...
         {
            _loc8_ = _loc7_ + 3;
            _loc9_ = this._rawData[_loc8_] / 255 * param2;
            if(_loc9_ > 1)
            {
               _loc9_ = 1;
            }
            ...
            else
            {
               ...
               _loc10_ = unmultiplyAlpha(switchEndian(this._rawData.readUnsignedInt()));
               _loc10_ = uint(_loc10_ & 0xFFFFFF00 | int(_loc9_ * 255) & 0xFF);
      ...
      public function colorize(param1:String = "color", param2:uint = 16777215, param3:Number = 1, param4:int = 0, param5:int = -1) : void
      {
         ...
         var _loc6_:int = param1 == "color" ? this._colOffset : this.getAttribute(param1).offset;
         var _loc7_:int = param4 * this._vertexSize + _loc6_;
         var _loc8_:int = _loc7_ + param5 * this._vertexSize;
         if(param3 > 1)
         {
            param3 = 1;
         }
         ...
         var _loc9_:uint = uint(param2 << 8 & 0xFFFFFF00 | int(param3 * 255) & 0xFF);
         if(_loc9_ == 4294967295 && param5 == this._numVertices)
         {
            this._tinted = false;
         }
      ...
      final private function getAttribute(param1:String) : VertexDataAttribute
      {
         var _loc2_:int = 0;
         var _loc3_:VertexDataAttribute = null;
         _loc2_ = 0;
      ...
      public function set numVertices(param1:int) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:VertexDataAttribute = null;
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         if(param1 > this._numVertices)
         {
            ...
            {
               _loc5_ = this._attributes[_loc4_];
               if(_loc5_.isColor)
               {
      ...
      public function set format(param1:VertexDataFormat) : void
      {
         ...
         var _loc9_:VertexDataAttribute = null;
         ...
         while(_loc2_ < _loc7_)
         {
            ...
            _loc9_ = this.getAttribute(_loc8_.name);
            if(_loc9_)
            {
