package starling.rendering
{
   ...
   public class IndexData
   {
      ...
      {
         var _loc1_:IndexData = new IndexData(this._numIndices);
      ...
      public function copyTo(param1:IndexData, param2:int = 0, param3:int = 0, param4:int = 0, param5:int = -1) : void
      {
         ...
         else
         {
            ...
            while(param5 > 1)
            {
               ...
               _loc15_ = ((_loc14_ & 0xFFFF0000) >> 16) + param3;
               _loc16_ = (_loc14_ & 0xFFFF) + param3;
      ...
      public function addTriangle(param1:uint, param2:uint, param3:uint) : void
      {
         ...
         if(this._useQuadLayout)
         {
            ...
            {
               _loc4_ = (this._numIndices & 1) != 0;
               _loc5_ = !_loc4_;
               if((_loc5_) && param2 == param1 + 1 && param3 == param2 + 1 || _loc4_ && param3 == param1 + 1 && param2 == param3 + 1)
               {
                  this._numIndices += 3;
