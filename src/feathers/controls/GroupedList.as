package feathers.controls
{
   ...
   public class GroupedList extends Scroller implements IFocusContainer
   {
      ...
      public function get selectedItem() : Object
      {
         ...
         var _loc1_:Object = this._dataProvider.getItemAt(this._selectedGroupIndex,this._selectedItemIndex);
      ...
      {
         if(Boolean(this._headerRendererFactories) && param1 in this._headerRendererFactories)
         {
      ...
      {
         if(Boolean(this._footerRendererFactories) && param1 in this._footerRendererFactories)
         {
      ...
      public function groupToHeaderData(param1:Object) : Object
      {
         ...
         if(Boolean(this._headerField != null) && Boolean(param1) && param1.hasOwnProperty(this._headerField))
         {
      ...
      public function groupToFooterData(param1:Object) : Object
      {
         ...
         if(Boolean(this._footerField != null) && Boolean(param1) && param1.hasOwnProperty(this._footerField))
         {
      ...
      override protected function initialize() : void
      {
         ...
         if(!_loc1_)
         {
            ...
            _loc2_.stickyHeader = !this._styleNameList.contains(ALTERNATE_STYLE_NAME_INSET_GROUPED_LIST);
      ...
      override protected function handlePendingScroll() : void
      {
         ...
         if(this.pendingGroupIndex >= 0)
         {
            ...
            if(_loc1_ is Object)
            {
               ...
               this.dataViewPort.getScrollPositionForIndex(this.pendingGroupIndex,this.pendingItemIndex,_loc2_);
               this.pendingGroupIndex = -1;
               this.pendingItemIndex = -1;
               _loc3_ = _loc2_.x;
               _loc4_ = _loc2_.y;
      ...
      override protected function nativeStage_keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         if(this._selectedGroupIndex != -1 && this._selectedItemIndex != -1 && (param1.keyCode == Keyboard.SPACE || (param1.keyLocation == 4 || DeviceCapabilities.simulateDPad) && param1.keyCode == Keyboard.ENTER))
         {
         ...
         {
            this.dataViewPort.calculateNavigationDestination(this._selectedGroupIndex,this._selectedItemIndex,param1.keyCode,this._helperLocation);
            _loc2_ = this._helperLocation[0];
            _loc3_ = this._helperLocation[1];
            if(_loc2_ == -1 || _loc3_ == -1)
            {
               this.setSelectedLocation(-1,-1);
            }
            else if(this._selectedGroupIndex != _loc2_ || this._selectedItemIndex != _loc3_)
            {
               param1.preventDefault();
               this.setSelectedLocation(_loc2_,_loc3_);
               _loc4_ = Pool.getPoint();
               this.dataViewPort.getNearestScrollPositionForIndex(this._selectedGroupIndex,this.selectedItemIndex,_loc4_);
      ...
      protected function dataProvider_addItemHandler(param1:Event, param2:Array) : void
      {
         ...
         if(param2.length > 1)
         {
            ...
            if(this._selectedGroupIndex == _loc3_ && this._selectedItemIndex >= _loc4_)
            {
      ...
      protected function dataProvider_removeItemHandler(param1:Event, param2:Array) : void
      {
         ...
         {
            _loc4_ = param2[1] as int;
            if(this._selectedGroupIndex == _loc3_)
            {
               if(this._selectedItemIndex == _loc4_)
               {
                  this.setSelectedLocation(-1,-1);
               }
               else if(this._selectedItemIndex > _loc4_)
               {
                  this.setSelectedLocation(this._selectedGroupIndex,this._selectedItemIndex - 1);
               }
            }
         }
         else if(this._selectedGroupIndex == _loc3_)
         {
            this.setSelectedLocation(-1,-1);
         }
         else if(this._selectedGroupIndex > _loc3_)
