   ...
   public class RenderState
   {
      ...
      public function copyFrom(param1:RenderState) : void
      {
         ...
         if(this._onDrawRequired != null)
         {
            ...
            _loc4_ = (this._miscOptions & 0x0F00) != (param1._miscOptions & 0x0F00);
            _loc5_ = (this._miscOptions & 0xF000) != (param1._miscOptions & 0xF000);
            _loc6_ = (this._miscOptions & 0x0F0000) != (param1._miscOptions & 0x0F0000);
      ...
      public function setRenderTarget(param1:Texture, param2:Boolean = true, param3:int = 0) : void
      {
         ...
         var _loc6_:uint = uint(MathUtil.min(param3,15) | uint(param2) << 4);
         var _loc7_:Boolean = _loc6_ != (this._miscOptions & 0xFF);
         if(_loc4_ != _loc5_ || _loc7_)
         {
            ...
            this._miscOptions = this._miscOptions & 0xFFFFFF00 | _loc6_;
         }
      }
      ...
      {
         var _loc1_:int = (this._miscOptions & 0x0F00) >> 8;
      ...
      public function set culling(param1:String) : void
      {
         ...
         if(this.culling != param1)
         {
            ...
            this._miscOptions = this._miscOptions & 0xFFFFF0FF | _loc2_ << 8;
         }
      }
      ...
      public function set depthMask(param1:Boolean) : void
      {
         if(this.depthMask != param1)
         {
            ...
            this._miscOptions = this._miscOptions & 0xFFFF0FFF | uint(param1) << 12;
         }
      }
      
      public function get depthTest() : String
      {
         var _loc1_:int = (this._miscOptions & 0x0F0000) >> 16;
      ...
      public function set depthTest(param1:String) : void
      {
         ...
         if(this.depthTest != param1)
         {
            ...
            this._miscOptions = this._miscOptions & 0xFFF0FFFF | _loc2_ << 16;
         }
      }
