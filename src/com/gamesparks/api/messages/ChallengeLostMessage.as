package com.gamesparks.api.messages
{
   ...
   public class ChallengeLostMessage extends GSResponse
   {
      
      public static var MESSAGE_TYPE:String = ".ChallengeLostMessage";
      
      public function ChallengeLostMessage(param1:Object)
      {
         super(param1);
      }
