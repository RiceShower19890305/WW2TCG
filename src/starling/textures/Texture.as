package starling.textures
{
   ...
   public class Texture
   {
      ...
      public static function empty(param1:Number, param2:Number, param3:Boolean = true, param4:Boolean = false, param5:Boolean = false, param6:Number = -1, param7:String = "bgra", param8:Boolean = false) : starling.textures.Texture
      {
         ...
         var _loc12_:ConcreteTexture = null;
         if(param6 <= 0)
         {
         ...
         var _loc16_:Boolean = !param8 && !param4 && Starling.current.profile != "baselineConstrained" && param7.indexOf("compressed") == -1;
         if(_loc16_)
         {
            ...
            _loc12_ = new ConcreteRectangleTexture(_loc11_ as RectangleTexture,param7,_loc9_,_loc10_,param3,param5,param6);
         }
         else
         {
            ...
            _loc12_ = new ConcretePotTexture(_loc11_ as flash.display3D.textures.Texture,param7,_loc9_,_loc10_,param4,param3,param5,param6);
         }
         ...
         return new SubTexture(_loc12_,new flash.geom.Rectangle(0,0,param1,param2),true);
      }
      ...
      public static function getMaxSize(param1:String = "bgra") : int
      {
         ...
         if(Boolean(!_loc5_ && _loc3_) && Boolean("supports8kTexture" in _loc3_) && Boolean(_loc3_["supports8kTexture"]))
         {
            return 8192;
         }
         return 4096;
