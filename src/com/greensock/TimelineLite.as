package com.greensock
{
   ...
   public class TimelineLite extends SimpleTimeline
   {
      ...
      override public function render(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         var _loc4_:Number = !_dirty ? _totalDuration : Number(this.totalDuration());
         ...
         else if(param1 < 1e-7)
         {
            ...
            {
               _rawPrevTime = Boolean(_duration || !param2) || Boolean(param1 !== 0) || _rawPrevTime === param1 ? param1 : _tinyNum;
               param1 = 0;
               if(!_initted)
               {
                  _loc13_ = true;
      ...
      public function getTweensOf(param1:Object, param2:Boolean = true) : Array
      {
         ...
         _loc6_ = TweenLite.getTweensOf(param1);
      ...
      public function clear(param1:Boolean = true) : *
      {
         ...
         var _loc3_:int = 0;
         _loc2_ = this.getChildren(false,true,true);
