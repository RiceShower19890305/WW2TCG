package com.fs.tcgengine.view.anims.cards
{
   ...
   public class AxeDamageAnimation extends BulletsAnim
   {
      
      private static const ARROW_IMPACT_EFFECT_IMAGE:String = "impact_effect";
      
      private static const AXE_NAILED_IMAGE:String = "axe_nailed";
      
      private var mImpactImage:FSImage;
      
      private var mShakeRequested:Boolean = false;
      
      public function AxeDamageAnimation(param1:FSCard, param2:int = -1, param3:String = "", param4:String = "", param5:Number = 0.04, param6:Boolean = true)
      {
         param3 = param3 == "" ? FSCardAnimsMng.ARROW_SOUND_NAME : param3;
         param4 = param4 == "" ? FSCardAnimsMng.AXE_DAMAGE_ANIM : param4;
         super(param1,param2,param3,param4,param5,param6);
      }
      
      override protected function getAmmoName() : String
      {
         return AXE_NAILED_IMAGE;
      }
      ...
      private function createImpactImage(param1:FSCoordinate) : void
      {
         ...
         {
            this.mImpactImage = new FSImage(Root.assets.getTexture(ARROW_IMPACT_EFFECT_IMAGE),false);
