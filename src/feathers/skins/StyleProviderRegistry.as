package feathers.skins
{
   ...
   public class StyleProviderRegistry
   {
      ...
      public function dispose() : void
      {
         ...
         for(_loc1_ in this._classToStyleProvider)
         {
            _loc2_ = Class(_loc1_);
      ...
      public function getRegisteredClasses(param1:Vector.<Class> = null) : Vector.<Class>
      {
         ...
         var _loc2_:int = 0;
         for(_loc3_ in this._classToStyleProvider)
         {
      ...
      public function getStyleProvider(param1:Class) : IStyleProvider
      {
         ...
         if(!_loc2_)
         {
            ...
            {
               param1[GLOBAL_STYLE_PROVIDER_PROPERTY_NAME] = _loc2_;
            }
         }
         return _loc2_;
      }
      ...
      public function clearStyleProvider(param1:Class) : IStyleProvider
      {
         ...
         if(param1 in this._classToStyleProvider)
         {
            ...
            if(this._registerGlobally && param1[GLOBAL_STYLE_PROVIDER_PROPERTY_NAME] === _loc2_)
            {
               param1[GLOBAL_STYLE_PROVIDER_PROPERTY_NAME] = null;
            }
            return _loc2_;
         }
         return null;
      ...
      {
         if(!this._registerGlobally || Object(param1).hasOwnProperty(GLOBAL_STYLE_PROVIDER_PROPERTY_NAME))
         {
            return;
         }
         throw ArgumentError("Class " + param1 + " must have a " + GLOBAL_STYLE_PROVIDER_PROPERTY_NAME + " static property to support themes.");
      }
   }
}
