package starling.display
{
   ...
   public class Image extends Quad
   {
      ...
      private function setupScale9Grid() : void
      {
         ...
         _loc10_ = this.setupScale9GridAttributes(sPadding.left,sPadding.top,sPosCols,sPosRows,sTexCols,sTexRows);
         _loc11_ = _loc10_ / 4;
      ...
      private function setupTileGrid() : void
      {
         ...
         _loc6_ = _loc3_.numVertices;
         var _loc7_:uint = _loc6_ ? _loc3_.getColor(0) : 16777215;
...
class SetupAutomator
{
   ...
   public function remove(param1:Function, param2:Function) : void
   {
      ...
      if(param2 != null)
      {
         _loc4_ = int(this._onRelease.indexOf(param2));
         if(_loc4_ != -1)
         {
