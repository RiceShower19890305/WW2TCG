package com.gamesparks.api.messages
{
   ...
   public class NewHighScoreMessage extends GSResponse
   {
      
      public static var MESSAGE_TYPE:String = ".NewHighScoreMessage";
      
      public function NewHighScoreMessage(param1:Object)
      {
         super(param1);
      }
