package starling.core
{
   ...
   public class Starling extends EventDispatcher
   {
      ...
      public static function get multitouchEnabled() : Boolean
      {
         ...
         var _loc1_:Boolean = Multitouch.inputMode == MultitouchInputMode.TOUCH_POINT;
      ...
      public static function set multitouchEnabled(param1:Boolean) : void
      {
         ...
         var _loc2_:Boolean = Multitouch.inputMode == MultitouchInputMode.TOUCH_POINT;
         Multitouch.inputMode = param1 ? MultitouchInputMode.TOUCH_POINT : MultitouchInputMode.NONE;
         var _loc3_:Boolean = Multitouch.inputMode == MultitouchInputMode.TOUCH_POINT;
         if(_loc2_ != _loc3_)
         {
      ...
      public function set showStats(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.showStatsAt(this._statsDisplayAlign.horizontal || "left",this._statsDisplayAlign.vertical || "top");
         }
      ...
      private function updateStatsDisplayPosition() : void
      {
         ...
         var _loc1_:String = this._statsDisplayAlign.horizontal;
         var _loc2_:String = this._statsDisplayAlign.vertical;
