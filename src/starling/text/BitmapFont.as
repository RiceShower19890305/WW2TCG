   ...
   public class BitmapFont implements ITextCompositor
   {
      ...
      private function parseFontXml(param1:XML) : void
      {
         ...
         if(param1.distanceField.length())
         {
            ...
            this._type = param1.distanceField.@fieldType == "msdf" ? BitmapFontType.MULTI_CHANNEL_DISTANCE_FIELD : BitmapFontType.DISTANCE_FIELD;
         }
         else
         {
            this._distanceFieldSpread = 0;
         ...
         for each(_loc6_ in param1.chars.char)
         {
            ...
            _loc12_ = new flash.geom.Rectangle();
      ...
      {
         var _loc11_:BitmapCharLocation = null;
         var _loc12_:Image = null;
         var _loc6_:Vector.<BitmapCharLocation> = this.arrangeChars(param1,param2,param3,param4,param5);
         ...
         while(_loc10_ < _loc7_)
         {
            ...
            _loc12_ = _loc11_.char.createImage();
            _loc12_.x = _loc11_.x;
            _loc12_.y = _loc11_.y;
      ...
      {
         var _loc10_:BitmapCharLocation = null;
         var _loc7_:Vector.<BitmapCharLocation> = this.arrangeChars(param2,param3,param4,param5,param6);
      ...
      {
         var _loc15_:BitmapCharLocation = null;
         var _loc16_:int = 0;
         var _loc17_:Number = NaN;
         ...
         var _loc31_:Vector.<BitmapCharLocation> = null;
         var _loc32_:Boolean = false;
         var _loc33_:int = 0;
         var _loc34_:BitmapChar = null;
         var _loc35_:int = 0;
         var _loc36_:Vector.<BitmapCharLocation> = null;
         var _loc37_:int = 0;
         var _loc38_:BitmapCharLocation = null;
         ...
         while(!_loc14_)
         {
            ...
            if(this._size <= _loc18_)
            {
               ...
               _loc29_ = 0;
               _loc30_ = 0;
               _loc31_ = BitmapCharLocation.vectorFromPool();
               ...
               while(_loc20_ < _loc16_)
               {
                  ...
                  else
                  {
                     ...
                     _loc15_ = BitmapCharLocation.instanceFromPool(_loc34_);
                     _loc15_.index = _loc20_;
                     ...
                     if(_loc15_.x + _loc34_.width > _loc17_)
                     {
                        if(_loc13_)
                        {
                           ...
                           _loc35_ = _loc27_ == -1 ? 1 : int(_loc20_ - _loc27_);
                           _loc21_ = 0;
         ...
         var _loc22_:Vector.<BitmapCharLocation> = BitmapCharLocation.vectorFromPool();
         ...
         {
            _loc36_ = sLines[_loc26_];
            _loc16_ = int(_loc36_.length);
            if(_loc16_ != 0)
            {
               _loc37_ = 0;
               _loc38_ = _loc36_[_loc36_.length - 1];
               _loc39_ = _loc38_.x - _loc38_.char.xOffset + _loc38_.char.xAdvance;
               ...
               {
                  _loc15_ = _loc36_[_loc40_];
                  _loc15_.x = _loc19_ * (_loc15_.x + _loc37_ + this._offsetX) + this._padding;
