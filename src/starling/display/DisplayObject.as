package starling.display
{
   ...
   public class DisplayObject extends EventDispatcher
   {
      ...
      public function getBounds(param1:DisplayObject, param2:flash.geom.Rectangle = null) : flash.geom.Rectangle
      {
      ...
      public function drawToBitmapData(param1:BitmapData = null, param2:uint = 0, param3:Number = 0) : BitmapData
      {
         ...
         {
            _loc16_ = this.getBounds(this._parent,sHelperRect);
            _loc14_ = _loc16_.x;
            _loc15_ = _loc16_.y;
      ...
      {
         var _loc1_:DisplayObject = this._parent || this._maskee;
      ...
      public function set width(param1:Number) : void
      {
         ...
         var _loc3_:Boolean = this._scaleX != this._scaleX;
         var _loc4_:Boolean = this._scaleX < 1e-8 && this._scaleX > -1e-8;
         if((_loc4_) || _loc3_)
         {
            this.scaleX = 1;
            _loc2_ = this.width;
      ...
      {
         var _loc2_:Number = NaN;
         var _loc3_:Boolean = this._scaleY != this._scaleY;
         var _loc4_:Boolean = this._scaleY < 1e-8 && this._scaleY > -1e-8;
         if((_loc4_) || _loc3_)
         {
            this.scaleY = 1;
            _loc2_ = this.height;
