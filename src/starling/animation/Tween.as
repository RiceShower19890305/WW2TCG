package starling.animation
{
   ...
   public class Tween extends EventDispatcher implements IAnimatable
   {
      ...
      public function advanceTime(param1:Number) : void
      {
         ...
         this._progress = _loc7_ ? Number(this._transitionFunc(1 - _loc6_)) : Number(this._transitionFunc(_loc6_));
         _loc2_ = 0;
         while(_loc2_ < _loc8_)
         {
            ...
            _loc9_ = this._updateFuncs[_loc2_] as Function;
            _loc9_(this._properties[_loc2_],this._startValues[_loc2_],this._endValues[_loc2_]);
            _loc2_++;
         }
      ...
      public function set transition(param1:String) : void
      {
         ...
         this._transitionFunc = Transitions.getTransition(param1);
