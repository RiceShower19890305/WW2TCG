package starling.text
{
   ...
   public class TextField extends DisplayObjectContainer
   {
      ...
      public function TextField(param1:int, param2:int, param3:String = "", param4:TextFormat = null, param5:TextOptions = null)
      {
         ...
         this._format = param4 ? param4.clone() : new TextFormat();
         this._format.addEventListener(Event.CHANGE,this.setRequiresRecomposition);
         this._options = param5 ? param5.clone() : new TextOptions();
      ...
      private function recompose() : void
      {
         ...
         var _loc2_:ITextCompositor = null;
         if(this._requiresRecomposition)
         {
            ...
            if(_loc2_ == null && _loc1_ == BitmapFont.MINI)
            {
      ...
      private function updateText() : void
      {
         ...
         _loc1_ = this._hitArea.width;
         _loc2_ = this._hitArea.height;
      ...
      private function updateBorder() : void
      {
         ...
         _loc4_ = this._border.getChildAt(1) as Quad;
