package starling.rendering
{
   ...
   public class Painter
   {
      ...
      {
         var _loc2_:Program = this.getProgram(param1);
         if(_loc2_)
         {
            _loc2_.dispose();
      ...
      {
         return this.programs[param1] as Program;
      }
      ...
      private function isRectangularMask(param1:DisplayObject, param2:DisplayObject, param3:Matrix) : Boolean
      {
         ...
         if(Boolean(_loc4_ && !_loc5_) && Boolean(!_loc6_) && _loc4_.texture == null)
         {
            if(param1.stage)
            {
      ...
      private function processCacheExclusions() : void
      {
         ...
         while(_loc1_ < _loc2_)
         {
            this._batchCacheExclusions[_loc1_].excludeFromCache();
            _loc1_++;
         }
      ...
      {
         var _loc1_:BatchProcessor = this._batchProcessorPrev;
      ...
      private function applyClipRect() : void
      {
         ...
         if(_loc1_)
         {
            ...
            _loc5_ = this._state.renderTarget;
            if(_loc5_)
            {
