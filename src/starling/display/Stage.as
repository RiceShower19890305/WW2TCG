package starling.display
{
   ...
   public class Stage extends DisplayObjectContainer
   {
      ...
      {
         this._enterFrameEvent.reset(Event.ENTER_FRAME,false,param1);
      ...
      public function getStageBounds(param1:DisplayObject, param2:flash.geom.Rectangle = null) : flash.geom.Rectangle
      {
         if(param2 == null)
         {
      ...
      public function getScreenBounds(param1:DisplayObject, param2:flash.geom.Rectangle = null) : flash.geom.Rectangle
      {
