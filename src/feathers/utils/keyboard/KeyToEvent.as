package feathers.utils.keyboard
{
   ...
   public class KeyToEvent
   {
      ...
      public function KeyToEvent(param1:IFocusDisplayObject = null, param2:uint = 32, param3:String = null)
      {
         super();
         this.target = param1;
         this.keyCode = param2;
      ...
      {
         var _loc2_:DefaultFocusManager = this._target.focusManager as DefaultFocusManager;
