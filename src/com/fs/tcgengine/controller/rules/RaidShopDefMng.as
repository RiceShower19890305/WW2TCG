package com.fs.tcgengine.controller.rules
{
   ...
   public class RaidShopDefMng extends DefMng
   {
      
      public function RaidShopDefMng(param1:String)
      {
         super(param1);
      }
      ...
      {
         return new RaidShopDef();
      }
      
      public function getItemsToShowInShop() : Array
      {
         var _loc3_:RaidShopDef = null;
         ...
         {
            if(_loc3_.getType() == FSShopItem.SHOP_ITEM_TYPE_PACK)
            {
         ...
         _loc1_.sort(DictionaryUtils.sortRaidShopItemsByPrice);
         return _loc1_;
      }
   }
}
