package feathers.media
{
   ...
   public class FullScreenToggleButton extends ToggleButton implements IMediaPlayerControl
   {
      ...
      public function set mediaPlayer(param1:IMediaPlayer) : void
      {
         ...
         {
            this._mediaPlayer.removeEventListener(MediaPlayerEventType.DISPLAY_STATE_CHANGE,this.mediaPlayer_displayStageChangeHandler);
         }
         this._mediaPlayer = param1 as VideoPlayer;
         if(this._mediaPlayer)
         {
            this.isSelected = this._mediaPlayer.isFullScreen;
            this._mediaPlayer.addEventListener(MediaPlayerEventType.DISPLAY_STATE_CHANGE,this.mediaPlayer_displayStageChangeHandler);
         }
      }
