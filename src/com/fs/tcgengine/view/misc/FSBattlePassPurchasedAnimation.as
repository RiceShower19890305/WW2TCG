package com.fs.tcgengine.view.misc
{
   ...
   public class FSBattlePassPurchasedAnimation extends FSVictoryAnimation
   {
      
      public function FSBattlePassPurchasedAnimation(param1:Function = null, param2:Array = null, param3:Boolean = false)
      {
      ...
      {
         super.createBG("battlepass_animation");
         if(mBG)
         {
            mBG.scale = 2;
         }
      ...
      override protected function createTextfield(param1:String = "TID_GEN_LEVEL_VICTORY") : void
      {
         if(mTextfield == null)
         {
            mTextfield = new FSTextfield(mBG.width * 0.8,mBG.height * 0.2,TextManager.getText("TID_BP_UNLOCKED"),16777215,FSResourceMng.FONT_STD_TITLE_SIZE);
         }
         ...
         if(mTextfield)
         {
            SpecialFX.createYoYoZoomTransition(mTextfield,1.2,2,-1,null,null,false);
         }
      }
