   ...
   public class DelayedDownTouchToState extends TouchToState
   {
      ...
      override public function set target(param1:DisplayObject) : void
      {
         ...
         if(this._target === null && this._stateDelayTimer !== null)
         {
            ...
            this._stateDelayTimer.removeEventListener(TimerEvent.TIMER_COMPLETE,this.stateDelayTimer_timerCompleteHandler);
      ...
      {
         if(Boolean(this._stateDelayTimer) && this._stateDelayTimer.running)
         {
            this._delayedCurrentState = param1;
            return;
         }
         if(param1 === ButtonState.DOWN)
         {
