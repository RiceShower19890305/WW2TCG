package starling.textures
{
   ...
   public class SubTexture extends Texture
   {
      ...
      starling_internal function setTo(param1:Texture, param2:Rectangle = null, param3:Boolean = false, param4:Rectangle = null, param5:Boolean = false, param6:Number = 1) : void
      {
         ...
         if(Boolean(Capabilities.isDebugger) && Boolean(this._frame) && (this._frame.x > 0 || this._frame.y > 0 || this._frame.right + E < this._width || this._frame.bottom + E < this._height))
         {
         }
         this.updateMatrices();
      }
