package com.gsolo.encryption
{
   public class SHA1
   {
      ...
      public static function str2binb(param1:String) : Array
      {
         ...
         {
            _loc2_[_loc4_ >> 5] |= (param1.charCodeAt(_loc4_ / chrsz) & _loc3_) << 32 - chrsz - _loc4_ % 32;
            _loc4_ += chrsz;
         }
         return _loc2_;
      }
      ...
      public static function binb2str(param1:Array) : String
      {
         ...
         {
            _loc2_ += String.fromCharCode(param1[_loc4_ >> 5] >>> 32 - chrsz - _loc4_ % 32 & _loc3_);
            _loc4_ += chrsz;
         }
         return _loc2_;
      }
      ...
      public static function binb2hex(param1:Array) : String
      {
         ...
         {
            _loc3_ += _loc2_.charAt(param1[_loc4_ >> 2] >> (3 - _loc4_ % 4) * 8 + 4 & 0x0F) + _loc2_.charAt(param1[_loc4_ >> 2] >> (3 - _loc4_ % 4) * 8 & 0x0F);
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      public static function binb2b64(param1:Array) : String
      {
         ...
         while(_loc4_ < param1.length * 4)
         {
            _loc5_ = (param1[_loc4_ >> 2] >> 8 * (3 - _loc4_ % 4) & 0xFF) << 16 | (param1[_loc4_ + 1 >> 2] >> 8 * (3 - (_loc4_ + 1) % 4) & 0xFF) << 8 | param1[_loc4_ + 2 >> 2] >> 8 * (3 - (_loc4_ + 2) % 4) & 0xFF;
            _loc6_ = 0;
            while(_loc6_ < 4)
            {
               ...
               {
                  _loc3_ += _loc2_.charAt(_loc5_ >> 6 * (3 - _loc6_) & 0x3F);
               }
               _loc6_++;
            }
            _loc4_ += 3;
