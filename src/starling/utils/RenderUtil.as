package starling.utils
{
   ...
   public class RenderUtil
   {
      ...
      public static function createAGALTexOperation(param1:String, param2:String, param3:int, param4:Texture, param5:Boolean = true, param6:String = "ft0") : String
      {
         ...
         var _loc10_:String = (_loc9_) && param1 == "oc" ? param6 : param1;
         var _loc11_:String = "tex " + _loc10_ + ", " + param2 + ", fs" + param3 + " <2d, " + _loc8_ + ">\n";
         if(_loc9_)
         {
            if(param1 == "oc")
            {
               _loc11_ += "mul " + _loc10_ + ".xyz, " + _loc10_ + ".xyz, " + _loc10_ + ".www\n";
               _loc11_ = _loc11_ + ("mov " + param1 + ", " + _loc10_);
            }
            else
            {
