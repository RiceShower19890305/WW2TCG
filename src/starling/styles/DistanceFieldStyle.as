      ...
      override public function batchVertexData(param1:MeshStyle, param2:int = 0, param3:Matrix = null, param4:int = 0, param5:int = -1) : void
      {
         ...
         if(param3)
         {
            ...
            if(!MathUtil.isEquivalent(_loc6_,1,0.01))
            {
               ...
               _loc8_ = DistanceFieldEffect.MAX_SCALE;
               _loc9_ = _loc8_ / 255;
               if(param5 < 0)
               {
               ...
               {
                  _loc11_ = vertexData.getUnsignedInt(param4 + _loc10_,"basic");
                  _loc12_ = (_loc11_ >> 24 & 0xFF) / 255 * _loc8_;
                  _loc13_ = MathUtil.clamp(_loc12_ * _loc6_,_loc9_,_loc8_);
                  _loc14_ = uint(_loc11_ & 0xFFFFFF | uint(_loc13_ / _loc8_ * 255) << 24);
...
class DistanceFieldEffect extends MeshEffect
{
   ...
   override protected function createProgram() : Program
   {
      ...
      if(texture)
      {
         ...
         var _temp_18:* = new <String>[tex("ft0","v0",0,texture),this._multiChannel ? median("ft0") : "mov ft0, ft0.xxxx","mov ft1, ft0",step("ft1.w","v6.x","v6.y"),"mov ft3, ft1","mul ft1, v1, ft1.wwww"];
         _loc4_ = new <String>[tex("ft0","v0",0,texture),this._multiChannel ? median("ft0") : "mov ft0, ft0.xxxx","mov ft1, ft0",step("ft1.w","v6.x","v6.y"),"mov ft3, ft1","mul ft1, v1, ft1.wwww"];
         if(_loc2_)
         {
