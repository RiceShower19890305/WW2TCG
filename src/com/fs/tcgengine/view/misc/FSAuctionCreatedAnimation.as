package com.fs.tcgengine.view.misc
{
   ...
   public class FSAuctionCreatedAnimation extends FSVictoryAnimation
   {
      
      public function FSAuctionCreatedAnimation(param1:Function = null, param2:Array = null, param3:Boolean = false)
      {
      ...
      override protected function createTextfield(param1:String = "TID_GEN_LEVEL_VICTORY") : void
      {
         if(mTextfield == null)
         {
            mTextfield = new FSTextfield(mBG.width * 0.8,mBG.height * 0.2,TextManager.getText("TID_AUCTIONS_AUCTION_CREATED"),16777215,FSResourceMng.FONT_STD_TITLE_SIZE);
         }
