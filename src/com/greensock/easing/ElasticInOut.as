package com.greensock.easing
{
   public final class ElasticInOut extends Ease
   {
      ...
      {
         param1 = param1 * 2;
         return param1 < 1 ? -0.5 * (_p1 * Math.pow(2,10 * (param1 = param1 - 1)) * Math.sin((param1 - _p3) * _2PI / _p2)) : _p1 * Math.pow(2,-10 * (param1 = param1 - 1)) * Math.sin((param1 - _p3) * _2PI / _p2) * 0.5 + 1;
      }
