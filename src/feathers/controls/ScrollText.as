package feathers.controls
{
   ...
   public class ScrollText extends Scroller implements INativeFocusOwner
   {
      ...
      public function set fontStyles(param1:starling.text.TextFormat) : void
      {
      ...
      public function set disabledFontStyles(param1:starling.text.TextFormat) : void
      {
         if(this.processStyleRestriction(arguments.callee))
         {
            return;
      ...
      {
         this.dispatchEventWith(Event.TRIGGERED,false,param2);
      }
