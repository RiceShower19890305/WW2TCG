package com.junkbyte.console.view
{
   ...
   public class PanelsManager
   {
      ...
      public function setPanelArea(param1:String, param2:flash.geom.Rectangle) : void
      {
      ...
      public function tooltip(param1:String = null, param2:ConsolePanel = null) : void
      {
         ...
         if(param1)
         {
            ...
            if(param2)
            {
               ...
               _loc5_ = new flash.geom.Rectangle(param2.x,param2.y,param2.width,param2.height);
