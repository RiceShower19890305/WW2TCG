package feathers.controls
{
   ...
   public class PanelScreen extends Panel implements IScreen
   {
      ...
      {
         this.addEventListener(Event.ADDED_TO_STAGE,this.panelScreen_addedToStageHandler);
         super();
      ...
      {
         this.addEventListener(Event.REMOVED_FROM_STAGE,this.panelScreen_removedFromStageHandler);
         var _loc2_:int = -getDisplayObjectDepthFromStage(this);
         this.stage.starling.nativeStage.addEventListener(KeyboardEvent.KEY_DOWN,this.panelScreen_nativeStage_keyDownHandler,false,_loc2_,true);
      }
      
      protected function panelScreen_removedFromStageHandler(param1:Event) : void
      {
         this.removeEventListener(Event.REMOVED_FROM_STAGE,this.panelScreen_removedFromStageHandler);
         this.stage.starling.nativeStage.removeEventListener(KeyboardEvent.KEY_DOWN,this.panelScreen_nativeStage_keyDownHandler);
      }
