package com.fs.tcgengine.model.boosts
{
   ...
   public class BoostDecreaseHP extends Boost
   {
      
      public function BoostDecreaseHP(param1:BoostDef)
      {
         super(param1);
      }
      ...
      override public function execute() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_ = _loc2_.getOpponentBattleInfo();
            if(_loc1_ != null)
            {
               _loc3_ = mBoostDef.getValue();
               _loc1_.modifyHP(new FSNumber(_loc3_),true);
            }
            Utils.setLogText(TextManager.replaceParameters(TextManager.getText("TID_BOOST_HP_DECREASE"),[_loc3_]));
            super.execute();
         }
         else
         {
